...
const Navbar = () => {
    ...
    return (
        <>
                ...
                <nav className="flex justify-between bg-gray-900 text-white">
                    <div className="px-5 xl:px-12 py-3 flex w-full items-center">
                        ...
                        <div className="hidden xl:inline-block w-32">
                            ...
                            <ul className="hidden min-w-max absolute text-base z-40 float-left py-2 list-none text-left rounded-lg shadow-lg mt-1 m-0 bg-clip-padding border-none bg-gray-800" ref={accountMenu}>
                                <li>
            ...
            <div className="fixed bottom-0 right-24 mb-4 mr-4 z-10 inline">
                <Link href="/signup">
            ...
            <div className="fixed bottom-0 right-0 mb-4 mr-4 z-10 inline">
                <Link href="/login">
