  ...
  return (
      <div className="flex h-[calc(100vh-80px)] items-center justify-center p-5 w-full bg-white">
        <div className="text-center">
          ...
          <h1 className="mt-5 text-[36px] font-bold text-slate-800 lg:text-[50px]">404 - <span>{error.message}</span></h1>
          <button onClick={() => router.push("/")} className="text-white bg-[#480cfc] border-0 py-2 px-6 focus:outline-none hover:bg-[#3a0aca] rounded text-lg transition-all transform hover:scale-105">Go to Home</button>
        </div>
      </div>
  );
}